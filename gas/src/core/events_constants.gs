...
var SystemEventTypes = Object.freeze({
  ...
  ACTION_INDICATOR_LINKED: 'ACTION_INDICATOR_LINKED',
  ...
  STRATEGY_ACTION_LINKED:      'STRATEGY_ACTION_LINKED',
  STRATEGY_ACTION_UNLINKED:    'STRATEGY_ACTION_UNLINKED',
  STRATEGY_COMPLETED:          'STRATEGY_COMPLETED',
  STRATEGY_RISK_ALERT:         'STRATEGY_RISK_ALERT',

  // ────────────────────────────────────────────
  // CONTRATAÇÕES — FASE 11 (schema operacional)
  // ────────────────────────────────────────────
  CONTRATACAO_PARCELA_PAGA:       'CONTRATACAO_PARCELA_PAGA',
  CONTRATACAO_QUITADA:            'CONTRATACAO_QUITADA',
  CONTRATACAO_PARCELA_VENCIDA:    'CONTRATACAO_PARCELA_VENCIDA',
  CONTRATACAO_APROVACAO_PARADA:   'CONTRATACAO_APROVACAO_PARADA',
  CONTRATACAO_APROVACAO_GARGALO:  'CONTRATACAO_APROVACAO_GARGALO',
  CONTRATACAO_SALDO_CRITICO:      'CONTRATACAO_SALDO_CRITICO',
  CONTRATACAO_COTACAO_RECEBIDA:   'CONTRATACAO_COTACAO_RECEBIDA',
  CONTRATACAO_INSTRUIDA:          'CONTRATACAO_INSTRUIDA',
  CONTRATACAO_DOCUMENTO_ADICIONADO:'CONTRATACAO_DOCUMENTO_ADICIONADO',
  CONTRATACAO_TOKEN_GERADO:       'CONTRATACAO_TOKEN_GERADO',
  PORTAL_ACESSO_EXTERNO:          'PORTAL_ACESSO_EXTERNO'
