...
**Fase atual**: **Feat — Rescisão: consolidado de holerites + break-even com dias + férias em dobro (CLT 137) + alertas visuais de férias + emails automáticos semanais — Deploy @896.**
