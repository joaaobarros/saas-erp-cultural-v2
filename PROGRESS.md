...
**Fase atual**: **Auditoria HUB-10 (2026-06-06)** — Deploy @646. HUB-10 CORRIGIDO: `.th-item` alinhado com DS — padding `12px 16px` (era `10px 14px`), margem `8px` (era `6px`), `transition:box-shadow var(--fast)` (era `.15s` hardcoded), ícone 32×32 (era 30×30); CSS morto `.th-prod-card/.th-prod-valor/.th-prod-label` removido (nunca usado — `_prodCard()` usa `stat-card`).
